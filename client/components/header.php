                            ...
                            <div class="dropdown-body">
                                <ul class="chat-list">
                                    ...
                                    <li class="chat-item">
                                        <a class="chat-link" href="#">
                                            <div class="chat-media user-avatar">
                                                <img src="../ops_assets/images/avatar/b-sm.jpg" alt="">
                                            </div>
                                            <div class="chat-info">
                                                <div class="chat-from">
                                        ...
                                        <a class="chat-link" href="#">
                                            <div class="chat-media user-avatar user-avatar-multiple">
                                                <div class="user-avatar">
                                                    <img src="../ops_assets/images/avatar/c-sm.jpg" alt="">
                                                </div>
                                                <div class="user-avatar">
                                                    <span>AB</span>
                                                </div>
                                    ...
                                    <li class="chat-item">
                                        <a class="chat-link" href="#">
                                            <div class="chat-media user-avatar">
                                                <img src="../ops_assets/images/avatar/a-sm.jpg" alt="">
                                                <span class="status dot dot-lg dot-success"></span>
                                            </div>
                                            <div class="chat-info">
                                                <div class="chat-from">
                        ...
                        <a href="#" class="dropdown-toggle me-n1" data-bs-toggle="dropdown">
                            <div class="user-toggle">
                                ...
                                <div class="user-info d-none d-xl-block">
                                    ...
                                    <div class="user-name dropdown-indicator"><?php echo $_SESSION['firstName']; ?></div>
                                </div>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end">
                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                <div class="user-card">
                                    ...
                                    <div class="user-info">
                                        <span class="lead-text"><?php echo $_SESSION['firstName']; ?></span>
                                        <span class="sub-text"><?php echo $_SESSION['emailAddress']; ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li><a href="../auth/logout.php"><em class="icon ni ni-signout"></em><span>Sign out</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
